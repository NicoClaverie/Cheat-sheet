...
## Sommaire 
[1) Tableau](#1-tableau-récapitulatif)  
[2) Obtenir la liste des interfaces réseau](#2-obtenir-la-liste-des-interfaces-réseau)  
[3) Renommer une interface réseau](#3-renommer-une-interface-réseau)  
[4) Activer, désactiver ou redémarrer une interface réseau](#4-activer-désactiver-ou-redémarrer-une-interface-réseau)  
[5) Obtenir la configuration IP d'une interface](#5-obtenir-la-configuration-ip-dune-interface)  
[6) Définir une adresse IPv4](#6-définir-une-adresse-ipv4)  
[7) Définir un serveur DNS sur l'interface réseau](#7-définir-un-serveur-dns-sur-linterface-réseau)  
[8) Définir un suffixe DNS](#8-définir-un-suffixe-dns)  
[9) Tester la résolution de noms](#9-tester-la-résolution-de-noms)  
[10) Effectuer un test de connectivité](#10-effectuer-un-test-de-connectivité)  
[11) Tester un port](#11-tester-un-port)  
[Sources](#sources)  
